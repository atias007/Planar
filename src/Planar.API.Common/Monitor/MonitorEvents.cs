...
public static class MonitorEventsParser
{
    public static bool TryParse(string? value, out MonitorEvents result)
    {
        var res = Parse(value);
        if (res.HasValue)
        {
    ...
    public static MonitorEvents? Parse(string? value)
    {
