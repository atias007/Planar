...
public static class AppSettingsInitializer
{
    ...
    public static async Task Initialize()
    {
        ...
        var config = await ReadAppSettings();
    ...
    private static async Task<IConfiguration> ReadAppSettings()
    {
        var file1 = FolderConsts.GetSpecialFilePath(PlanarSpecialFolder.Settings, "AppSettings.yml");
        var file2 = FolderConsts.GetSpecialFilePath(PlanarSpecialFolder.CentralConfig, "CentralConfig.json");
        ...
        try
        {
            ...
            using var stream = await YmlFileReader.ReadStreamAsync(file1);
