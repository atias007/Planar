...
namespace AsciiChart.Sharp
{
    public static class AsciiChart
    {
        ...
        public static string Plot(IEnumerable<IEnumerable<double>> data, Options? options = null)
        {
            ...
            {
                var color = options.SeriesColors?.Count > i ? options.SeriesColors[i++] : AnsiColor.Default;
        ...
        private static IEnumerable<double> GetYAxisTicks(double max, double range, double rows)
        {
        ...
        private static void ApplyYAxisLabels(IReadOnlyList<string[]> resultArray, IReadOnlyList<AnsiColor[]> colorArray, IReadOnlyList<AxisLabel> yAxisLabels, int columnIndexOfFirstDataPoint, Options options)
        {
        ...
        private static string ToString(IReadOnlyList<string[]> resultArray, IReadOnlyList<AnsiColor[]> colorArray)
        {
        ...
        private static string ColorString(AnsiColor color)
        {
        ...
        private sealed class AxisLabel
        {
