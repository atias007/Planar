...
namespace Planar.CLI.Entities
{
    public class CliAddUserRequest
    {
        ...
        [ActionProperty("f", "first-name", InputDisplay = "first name")]
        [Required("firstname argument is required")]
        public string FirstName { get; set; } = string.Empty;

        [ActionProperty("l", "last-name", InputDisplay = "last name")]
        public string? LastName { get; set; }

        [ActionProperty("e", "email", InputDisplay = "email address")]
        public string? EmailAddress1 { get; set; }

        [ActionProperty("p", "phone-number", InputDisplay = "phone number")]
        public string? PhoneNumber1 { get; set; }
    }

    public class CliUpdateUserRequest : CliAddUserRequest
    {
        [ActionProperty("e2", "email2", InputDisplay = "email address 2")]
        public string? EmailAddress2 { get; set; }

        [ActionProperty("e3", "email3", InputDisplay = "email address 3")]
        public string? EmailAddress3 { get; set; }

        [ActionProperty("p2", "phone-number2", InputDisplay = "phone number 2")]
        public string? PhoneNumber2 { get; set; }

        [ActionProperty("p3", "phone-number3", InputDisplay = "phone number 3")]
