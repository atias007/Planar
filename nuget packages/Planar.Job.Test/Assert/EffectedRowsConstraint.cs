...
namespace Planar.Job.Test
{
    public class EffectedRowsConstraint : BasePlanarConstraint
    {
        ...
        public AssertPlanarConstraint IsGreaterThen(int value)
        {
            ...
            var message = $"Expect to be greater then {value} but current value is {_result.EffectedRows}";
        ...
        {
            if (_result.EffectedRows >= value) { return Assert; }
            var message = $"Expect to be greater or equals to {value} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows < value) { return Assert; }
            var message = $"Expect to be less then to {value} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows <= value) { return Assert; }
            var message = $"Expect to be less then or equals to {value} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        public AssertPlanarConstraint IsBetweenExclusive(int from, int to)
        {
            ...
            var message = $"Expect to be between exclusive {from} to {to} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows >= from && _result.EffectedRows <= to) { return Assert; }
            var message = $"Expect to be between inclusive {from} to {to} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows < from || _result.EffectedRows > to) { return Assert; }
            var message = $"Expect to be not between exclusive {from} to {to} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows == value) { return Assert; }
            var message = $"Expect to be equals to {value} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows != value) { return Assert; }
            var message = $"Expect to be not equals to {value} but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        public AssertPlanarConstraint IsZero()
        {
            ...
            var message = $"Expect to be 0 but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        public AssertPlanarConstraint IsNull()
        {
            ...
            var message = $"Expect to be null but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        public AssertPlanarConstraint IsEmpty()
        {
            ...
            var message = $"Expect to be empty (null or zero) but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows != null) { return Assert; }
            var message = $"Expect to be not null but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
        ...
        {
            if (_result.EffectedRows.GetValueOrDefault() > 0) { return Assert; }
            var message = $"Expect to be not empty (null or zero) but current value is {_result.EffectedRows}";
            throw new AssertPlanarException(message);
        }
    }
}